...
export const portfolio = [
  {
    ...
    description: "Casino application development, live betting",
    img: ImgXYES,
  ...
  },
  {
    ...
    skills: ["Angular", "SASS", "TypeScript",],
  },
  ...
  {
    title: "DeliveryGo",
    description: "Delivery application, for delivery and products. front and back",
    img: imgDeliveryGo,
