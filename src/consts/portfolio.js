...
import ImgAlianza from "../assets/portfolio/alianza.png";
import imgSagal from "../assets/portfolio/appVentas.png";
import ImgBoutique from "../assets/portfolio/boutique.png";
...
export const MOCK_PORTFOLIO = [
    {
        ...
        description:
          "Library of components development in react",
        img: ImgLibray,
        link: "",
        skills: ["React", "Storybook", "TypeScript"],
    },  
    {
        title: "La boutique del costurero",
        description:
          "Landing page developed for printing store",
        img: ImgBoutique,
        link: "https://boutique.atcode23.com/#/",
        skills: ["Vue", "Quasar", "TypeScript"],
    },
    {
        title: "Alianza",
        description:
